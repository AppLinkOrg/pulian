...
var pingpai = () => {
  // caridname
  store.changebrand_name(
    brand_name.value,
    model_name.value,
    series_name.value,
    provinces_name.value,
    vin.value,
    engineno.value,
...
<template>
  <div v-if="page.Res != null">
    <div class="padding-15">
        ...
        <div class="padding-15">
          <div class="padding-add bg-w border-radius-9">
            ...
            <div class="h-53 flex-row flex-center margin-left-14 margin-right-14">
              ...
              <div class="flex-row" @click="showpopup((type = 1), (status = true))">
            ...
            <div class="h-1 bg-1"></div>
            <div class="h-53 flex-row flex-center margin-left-14 margin-right-14" @click="pingpai">
            ...
            <div class="h-53 flex-row flex-center margin-left-14 margin-right-14">
              ...
              <van-field v-model="vin" @update:model-value="vin_input" placeholder="请输入车架号" />
            </div>
            <div class="h-1 bg-1"></div>
            <div class="h-53 flex-row flex-center margin-left-14 margin-right-14">
      ...
      <div class="c-2 margin-top-10 f-12">所填信息我们将严格保密，请您放心填写</div>
    </div>
    <!--  -->
