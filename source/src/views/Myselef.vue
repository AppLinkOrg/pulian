...
<template>
  <div v-if="page.Res != null && page.Memberinfo != null">
    ...
    <div class="flex-row flex-center margin-top-36">
      <img
        :src="page.Memberinfo.avatarUrl"
        class="icon-55 border-radius-50 margin-left-14"
        @click="shouquan()"
      />
      ...
      >
        <img
          :src="page.uploadpath + 'resource/' + page.Res.qianbao"
          class="icon-20 border-radius-50"
        />
    ...
    <!-- <div class="flex-row flex-center margin-top-30">
      ...
      <div @click="kazhuan()">
        <div class="c-6 bold f-20 center">
          {{ len }}
        </div>
      ...
      <div @click="shoucan">
        <div class="c-6 bold f-20 center">
          {{ shumu == null ? 0 : shumu.result.num2 }}
        </div>
    ...
    <div class="margin-left-14 margin-right-14 bg-w border-radius-9 padding-15 margin-top-20">
      ...
      <div class="flex-row flex-center margin-top-20">
        <div class="flex-1" @click="daifu('A')">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.daiful"
            class="icon-28 displat-block margin-auto"
          />
          <div class="margin-top-10 c-1 f-12 center">待付款</div>
        </div>
        <div class="flex-1" @click="daifu('B')">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.kehsi"
            class="icon-28 displat-block margin-auto"
          />
        ...
        <div class="flex-1" @click="daifu('daip')">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.pinjia"
            class="icon-28 displat-block margin-auto"
          />
        ...
        <div class="flex-1" @click="daifu('er')">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.tuikuan"
            class="icon-28 displat-block margin-auto"
          />
    ...
    <div class="margin-left-14 margin-right-14 bg-w border-radius-9 padding-15 margin-top-10">
      ...
      <div v-if="mycarlist.length == 0">
        <img
          :src="page.uploadpath + 'resource/' + page.Res.qiche"
          class="icon-50 displat-block margin-auto"
          @click="addaiche()"
        />
    ...
    <div class="margin-left-14 margin-right-14 bg-w border-radius-9 padding-15 margin-top-10">
      ...
      <div class="flex-row flex-center margin-top-20">
        <div class="flex-1" @click="shiyong">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.shiyon"
            class="icon-28 displat-block margin-auto"
          />
        ...
        <div class="flex-1" @click="hehuo">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.hezuo"
            class="icon-28 displat-block margin-auto"
          />
        ...
        <div class="flex-1" @click="lianxigg">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.lainxi"
            class="icon-28 displat-block margin-auto"
          />
        ...
        <div class="flex-1" @click="guaunyu">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.guanyu"
            class="icon-28 displat-block margin-auto"
          />
      ...
      <div class="flex-row flex-center margin-top-20">
        <div class="flex-1" @click="dizhi">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.dizhiguanli"
            class="icon-28 displat-block margin-auto"
          />
        ...
        <div class="flex-1" @click="fankui">
          <img
            :src="page.uploadpath + 'resource/' + page.Res.yijianfan"
            class="icon-28 displat-block margin-auto"
          />
