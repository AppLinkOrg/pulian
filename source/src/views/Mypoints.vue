  ...
  <div v-if="page.Res != null">
    ...
    <div class="margin-left-14 margin-right-14">
      ...
      <div class="flex-row flex-center margin-top-16">
        ...
        <div class="f-30 bold c-w margin-left-4" v-if="page.Memberinfo != null">{{ integral }}</div>
        <div class="flex-1"></div>
        <div
          class="h-25 padding-left-10 padding-right-10 line-height-25 f-12 c-6 bg-w border-radius-12"
          @click="chongzhi"
        >积分充值</div>
      </div>
    </div>
    ...
    <div class="margin-left-14 margin-right-14 border-radius-9 bg-w padding-15 margin-top-30">
      ...
      <div class="margin-top-40 flex-row flex-center">
        <div v-for="(item, index) in qiandaocha.result" :key="index">
          <div class="margin-right-16">
            <div
              class="border-radius-50 icon-30 bg-1 line-height-30 f-12 c-8 bold center"
              v-if="item == 0"
            >+{{instinfo.zengsong}}</div>
            <img :src="page.uploadpath + 'resource/' + page.Res.xinxin" class="icon-30" v-else />
            <div class="margin-top-5 c-2 f-9 center" style="white-space: nowrap">
              周{{
              index == 0
              ? "一"
              : index == 1
      ...
      <div
        class="margin-left-20 margin-right-20 bg-5 center c-w f-16 h-40 line-height-40 margin-top-25 border-radius-20"
        @click="qiandao"
      >{{ qiandaocha2 == 1 ? "已签到" : "签到" }}</div>
    </div>
    ...
    <div class="margin-left-14 margin-right-14">
      <div class="bg-w border-radius-5 padding-15">
        <div class="flex-row flex-center">
          ...
          <div class="flex-1"></div>
          <div
            class="f-12 c-6 padding-left-14 padding-right-14 h-25 line-height-25 border-radius-12 bd-5"
            :class="[
