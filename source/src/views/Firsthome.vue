...
<template >
  <div v-if="page.Res!=null" class="big-bg">
    ...
    <!-- 列表 -->
    <div class="flex-row flex-center margin-top-20 margin-left-26 margin-right-26" >
     <div class="flex-1 flex-row flex-center">
    
<img :src="page.uploadpath + 'resource/' + page.Res.fuwu2" class="icon-15"/>
 ...
 <div class="flex-1"></div>
     ...
     <div class="shu"></div>
         <div class="flex-1 flex-row flex-center">
         <div class="flex-1"></div>
<img :src="page.uploadpath + 'resource/' + page.Res.zhuce" class="icon-15"/>
 ...
 <div class="flex-1"></div>
     ...
     <div class="shu "></div>
         <div class="flex-1 flex-row flex-center">
           <div class="flex-1"></div>
<img :src="page.uploadpath + 'resource/' + page.Res.koubai" class="icon-15"/>
 ...
 <div class="flex-1"></div>
     ...
     <div class="shu"></div>
       <div class="flex-1 flex-row flex-center">
        <div class="flex-1"></div>
<img :src="page.uploadpath + 'resource/' + page.Res.fuwu" class="icon-15"/>
    ...
    <!-- 按钮 -->
    <div class="flex-row flex-center  margin-left-23" style="display: flex;display: -webkit-flex;justify-content: space-between;flex-direction: row;flex-wrap: wrap;">
      <div v-for="(item,index) in anniulist" :key="index" class="margin-top-20 margin-right-30">
        <img :src="page.uploadpath + 'anniu/' + item.img" class="icon-42 displat-block margin-auto"  />
...
<img :src="page.uploadpath + 'resource/' + page.Res.xinren" class="h-93 wf-100"/>
<!-- 附近门店 -->
...
<!-- 分类 -->
  ...
  <div class="flex-row flex-center margin-top-14 margin-bottom-14" style="  overflow: scroll;">
  <div class="padding-left-10 padding-right-10 bg-1  c-2 f-11 h-22 border-radius-11 line-height-22 flex-none margin-right-10" v-for="(item,index) in servicelist" :key="index">
{{item.name}}
  </div>
</div>
 </div>
