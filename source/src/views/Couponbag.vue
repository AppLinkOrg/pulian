...
var goumai2 = () => {
  console.log("进来了11");
  HttpHelper.Post("youhuiorder/youhuiorderadd", {
        ...
        wx.miniProgram.getEnv((resrnv) => {
          if (resrnv.miniprogram) {
            ...
            wx.miniProgram.navigateTo({
              url: "/pages/pay/pay?id=" + res.return + "&type=B",
            });
          } else {
            // prepay8
            // prepay4
...
<template>
  <div v-if="page.Res != null && coupondetail != null">
    <div
      class="margin-left-14 margin-right-14 margin-top-14 bg-w border-radius-9"
    >
      <div class="h-130 flex-row flex-center">
        ...
        <van-image
          ...
          class="h-130"
          fit="contain"
          :src="page.uploadpath + 'coupon/' + coupondetail.img"
          v-if="coupondetail.img != ''"
        />
    ...
    <div
      ...
      "
    >
      <div class="c-2 f-14 bold">
        {{ type == "A" ? "使用规则" : "购买须知" }}
      </div>
      <div
        class="c-1 f-12 padding-bottom-15 padding-top-15"
    ...
    <div class="position-bottom" style="bottom: 20px" v-if="type != 'A'">
      <div
        ...
        @click="goumia"
      >
        <a class="c-w f-24">¥{{ coupondetail.price }}</a
        ><a class="c-w f-16">/{{ coupondetail.shangping }}张</a
        ><a class="c-w f-16 bold padding-left-14">立即购买</a>
      </div>
    </div>
  </div>
</template>
