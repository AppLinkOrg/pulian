...
export class WechatApi{
    ...
    gensign(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/gensign',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    paycarwash(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/paycarwash',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    prepay4(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/prepay4',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    prepay6(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/prepay6',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    ceshi(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/ceshi',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
