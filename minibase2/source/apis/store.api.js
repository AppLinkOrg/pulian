...
export class StoreApi{
    ...
    citilist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'store/citilist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    filtrate2(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'store/filtrate2',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    fuwulist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'store/fuwulist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    storedetail2(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'store/storedetail2',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    storelist3(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'store/storelist3',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
